  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between pb-2 border-b border-white/[0.06]">
        ...
        <span className="text-xs text-[#a1a1a1]">1 Recorded Run</span>
      </div>
            ...
            <div className="flex items-start sm:items-center gap-3.5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#22c55e]/15 text-[#22c55e] border border-[#22c55e]/30 font-semibold">
                    {sess.status}
                  </span>
                </div>
                <div className="flex flex-wrap items-center gap-3 text-xs text-[#a1a1a1]">
                  ...
                  <span>•</span>
                  <span className="flex items-center gap-1 font-mono text-[11px] text-[#22c55e]">
                    {sess.testsPassed}
                  </span>
                </div>
              </div>
